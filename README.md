...
Elgato Stream Deck SDK v2 · TypeScript / Node · 359 passing tests · `streamdeck validate` runs in the build · native helpers are universal (Apple Silicon + Intel), Developer ID signed & notarized.
