...
export function buildClaudeProjectKeyImage(args: {
	...
	const eyebrow = args.host
		? `<text x="36" y="15" text-anchor="middle" font-family="${MONO}" font-size="7.5" letter-spacing="1.2" fill="${eyebrowFill || "#8B9490"}">${escapeXml(truncate(args.host.toUpperCase(), 10))}</text>`
		: "";
